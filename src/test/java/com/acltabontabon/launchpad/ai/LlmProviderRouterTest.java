...
class LlmProviderRouterTest {
    ...
    void buildsOllamaDelegateWhenProviderIsOllama() {
        var router = newRouter(new Snapshot(
            LlmProvider.OLLAMA, "http://localhost:11434", "qwen2.5-coder:7b", null, null, null, false));
    ...
    void buildsOpenAiDelegateWhenProviderIsOpenAiCompatible() {
        var router = newRouter(new Snapshot(
            LlmProvider.OPENAI_COMPATIBLE, "http://localhost:1234/v1", "local-model", null, null, null, false));
